    ...
    controllers: {
        objectsController: {
            ...
            clickedObject: function () {
                top.location.href = '/Home/Currency/objectsDetail/id/' + $(this).parents('tr').attr('data-id') + '/type/60';
            },
            runRequest: function () {
        ...
        objectsDetailController: {
                        ...
                        events: {
                            load: function() {
                                ...
                                app.instance.controller.$liveRequestInterval = setInterval(function() {
                                    ...
                                    if (app.instance.controller.$liveRequest != null) app.instance.controller.$liveRequest.abort();
                                    app.instance.controller.$liveRequest = app.services.api('GET', 'objectsDetailUpdate/id/' + $('table.objectsDetail').attr('data-id') + '/type/' + $('table.objectsDetail').attr('data-period') + '/update', {}, function($response) {

                                        app.instance.controller.$liveResponse = $response;
                                        app.instance.controller.runRender();
                                        // alert($response.lines.created_at);
            ...
            clickedPeriod: function() {
                top.location.href = '/Home/Currency/objectsDetail/id/' + $(this).parents('table').attr('data-id') + '/type/' + $(this).attr('data-period');
            },
            ...
            runRequest: function() {
                if (app.instance.controller.$liveRequest != null) app.instance.controller.$liveRequest.abort();
                app.instance.controller.$liveRequest = app.services.api('GET', 'objectsDetail/id/' + $('table.objectsDetail').attr('data-id') + '/type/' + $('table.objectsDetail').attr('data-period'), {}, function($response) {
                    app.instance.controller.$liveResponse = $response;
