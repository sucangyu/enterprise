            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <?php if($goodsInfo['kind'] == 2): ?><li><a href="#tab_goods" data-toggle="tab" class="joink"  >收成信息</a></li>
                        <?php else: ?>
                            <li><a href="#tab_goods" data-toggle="tab" class="joink"  style="display:none">收成信息</a></li><?php endif; ?>


                    </ul>
                    <!--表单数据-->
                    <form method="post" id="addEditGoods" action="/enterprise/index.php/Admin/Goods/detail">
                            ...
                            <div class="tab-pane active" id="tab_tongyong">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" name="cat_id" style="width:350px;">
                                                <?php if(is_array($cationArr)): foreach($cationArr as $key=>$vo1): if($goodsInfo['cat_id'] == $vo1['id']): ?><option value="<?php echo ($vo1["id"]); ?>" selected><?php echo ($vo1["title"]); ?></option>
                                                    <?php else: ?>
                                                        <option value="<?php echo ($vo1["id"]); ?>"><?php echo ($vo1["title"]); ?></option><?php endif; endforeach; endif; ?>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="show_pics">
                                                <?php if(is_array($goodsInfo['original_img'])): foreach($goodsInfo['original_img'] as $k=>$vo): ?><div style="width:100px; text-align:center; margin: 5px; display:inline-block;float: left;" class="goods_xc">
