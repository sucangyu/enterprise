        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i>友情链接</h3>
                </div>
                <div class="panel-body">
                    <!--表单数据-->
                    <form method="post" id="addEditProjForm" action="/enterprise/index.php/Admin/Company/linkdetail">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_tongyong">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>友情链接名称:<i style="color: red;">*</i></td>
                                        <td>
                                            <input type="text" value="<?php echo ($linkArr["name"]); ?>" name="name" maxlength="20" class="form-control" style="width:50vw;"/>
                                            <span id="err_name" class="error" style="color:#F00; display:none;"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>友情链接地址:<i style="color: red;">*</i></td>
                                        <td>
                                            <input type="text" value="<?php echo ($linkArr["url"]); ?>" name="url" maxlength="200" class="form-control" style="width:50vw;"/>
                                            <span id="err_url" class="error" style="color:#F00; display:none;"></span>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="pull-left">
                            <input type="hidden" name="id" value="<?php echo ($linkArr["id"]); ?>">
...
<script>
    $("#bao").click(function(){
        ...
        if (!name) {
            error += '必须添加友情链接名称,   ';
            $("#err_name").html('必须添加友情链接名称');
            $("#err_name").css('display','block');
        }
        if (!url) {
            error += '必须添加友情链接地址,   ';
            $("#err_url").html('必须添加友情链接地址');
            $("#err_url").css('display','block');
        }
