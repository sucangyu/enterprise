            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-list"></i> <span class="title">数据库在线备份下载和还原</span>
                        <a href="<?php echo U('System/backupMysql',array('Action'=>'backup'));?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>备份添加</a>
                    </h3>
...
<script>
    ...
    function ajax_get_table(tab,page){
        ...
        var url = "<?php echo U('System/ajaxBackupMysql');?>";
        $.ajax({
            type : "POST",
            url:url+"?p="+page,//+tab,
