        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!--表单数据-->
                    <form method="post" id="addEditProjForm" action="/enterprise/index.php/Admin/Goods/addcation">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_tongyong">
                                ...
                                <table class="table table-bordered">
                                    <tbody>                                 
                                    <tr>
                                        <td>商品分类:<i style="color: red;">*</i></td>
                                        <td>
                                            <input type="text" value="" name="title" maxlength="20" class="form-control" style="width:50vw;"/>
