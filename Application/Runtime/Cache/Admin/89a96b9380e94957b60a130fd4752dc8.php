...
<div class="wrapper">
    ...
    <section class="content">
                ...
                <div class="box  box-success">
                    <div class="box-body">
                        <div class="info-box">
                            <table class="table table-bordered">
                                <tr>
                                    <td>程序版本：</td><td><?php echo ($store_name); ?> <?php echo ($sys_info["version"]); ?></td>
                                    <td>更新时间：</td><td>2016-07-10</td>
                                    <td>程序开发：</td><td>大周科技有限公司</td>
                                </tr>
                                <tr>
                                    <td>版权所有：</td><td>大周科技有限公司</td>
                                    <td>官方授权：</td><td><a href="#" target="_blank">大周科技有限公司</a></td>
                                    <td>官方论坛：</td><td><a href="#" target="_blank">大周科技</a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
        ...
        <div class="callout callout-success">
            <p> <b><?php echo ($store_name); ?></b>--由大周科技有限公司提供技术支持　　电话：18905811712（郭）</p>
        </div>
    </section>
</div>
</body>
