        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!--表单数据-->
                    <form method="post" id="addEditProjForm" action="/enterprise/index.php/Admin/Company/addlink">
                            ...
                            <div class="tab-pane active" id="tab_tongyong">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" value="" name="name" maxlength="20" class="form-control" style="width:50vw;"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" value="" name="url" maxlength="200" class="form-control" style="width:50vw;"/>
