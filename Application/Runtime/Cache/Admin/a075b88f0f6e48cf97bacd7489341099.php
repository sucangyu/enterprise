            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-list"></i> <span class="title">商品分类列表</span>
                        <button type="button" onclick="location.href='<?php echo U('Goods/addcation');?>'" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加商品分类</button>
                    </h3>
                    ...
                    <div class="navbar navbar-default">
                        <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                            <div class="form-group">
                                <label class="control-label" for="input-titles">商品分类名称</label>
                                <div class="input-group">
                                    <input type="text" name="title" value="" placeholder="商品分类名称" id="input-titles" class="form-control">
...
<script>
    ...
    function ajax_get_table(tab,page){
        ...
        var url = "<?php echo U('Goods/ajaxcationlist');?>";
        $.ajax({
            type : "POST",
            url:url+"?p="+page,//+tab,
