        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <!--表单数据-->
                    <form method="post" id="addEditProjForm" action="/enterprise/index.php/Admin/Newslist/addNew">
                            ...
                            <div class="tab-pane active" id="tab_tongyong">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" value="<?php echo ($newArr["title"]); ?>" name="title" class="form-control" style="width:550px;"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" value="<?php echo ($newArr["tag"]); ?>" name="tag" maxlength="30" class="form-control" style="width:150px;"/>
                                    ...
                                    <tr>
                                        ...
                                        <td width="85%">
                                            <textarea class="span12 ckeditor" style="width: 700px;height:500px;" id="content" name="content" title=""><?php echo ($newArr["content"]); ?></textarea>
                        ...
                        <div class="pull-left">
                            <input type="hidden" name="comp_id" value="<?php echo ($newArr["id"]); ?>">
