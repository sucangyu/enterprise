            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-list"></i> <span class="title">轮播图列表</span>
                        <button type="button" onclick="location.href='<?php echo U('Company/addimg');?>'" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加图片</button>
                    </h3>
                    ...
                    <div class="navbar navbar-default">
                        <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                            <div class="form-group">
                                <label class="control-label" for="input-titles">图片注释</label>
                                <div class="input-group">
                                    <input type="text" name="alt" value="" placeholder="图片注释" id="input-titles" class="form-control">
...
<script>
    ...
    function ajax_get_table(tab,page){
        ...
        var url = "<?php echo U('Company/ajaximglist');?>";
        $.ajax({
            type : "POST",
            url:url+"?p="+page,//+tab,
