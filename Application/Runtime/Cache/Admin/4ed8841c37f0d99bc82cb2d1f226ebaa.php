...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo ($store_name); ?> | 后台登陆</title>
...
<?php if(isset($message)) {?>    
      ...
      <div class="login-box-body">
        <h4 class="login-box-msg ver_cm"><span class="glyphicon glyphicon-ok ver_cm"></span> <?php echo($message); ?></h4>
          ...
          <!--<a href="{:U('Admin/Index/index')}" target="_parent">管理员后台</a>-->
...
<?php }?>      
	    <div class="margin text-center">
	        <div class="copyright">
	            2014-<?php echo date('Y');?> &copy; <a href=""><?php echo ($store_name); ?></a>
	            <br/>
	            <a href=""><?php echo ($store_name); ?></a>出品
	        </div>
	    </div>
    </div><!-- /.login-box -->
