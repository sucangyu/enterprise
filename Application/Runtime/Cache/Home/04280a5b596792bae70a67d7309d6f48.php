...
<body <?php if(isset($controller)) echo ' data-controller="' . $controller . '"';?> ontouchstart>
    ...
    <script src="/Public/js/technical-indicators.js"></script>
...
<div id="liveChart" style="width: 100%; height:20%; position: fixed; top: 0px;"></div>
...
<script type="text/html" id="templet_order_countDown">
 ...
 if($item['body_price_previous'] > $item['body_price']) echo 'green'; else echo 'red'; ?>"><?php echo(sprintf('%.' . $item['body_price_decimal'] . 'f', $item['body_price'])); ?></span>
                        </td>
                ...
                <table>
                    ...
                    <tr>
                        <td style="width: 50%; line-height: 1.5em; padding: 12px 0; border-bottom: 0;">
                            ...
                            <span id="donePrice" class="content price <?php
 if($item['body_price_previous'] > $item['body_price']) echo 'green'; else echo 'red'; ?>"><?php echo(sprintf('%.' . $item['body_price_decimal'] . 'f', $item['body_price'])); ?></span></span>
...
<div class="navigator clearfix">
        ...
        <a class="<?php echo ($navigator=='objects')? 'active' : '';?>" href="<?php echo U('Currency/index');?>" class="active"><span><img src="/Public/imgs/bar01<?php echo ($navigator=='objects')? '' : '_o';?>.png" width="24" height="24" /></span><br><span>商品价格</span></a>
        <a class="<?php echo ($navigator=='ordersHold')? 'active' : '';?>" href="/orders/hold"><span><img src="/Public/imgs/bar02<?php echo ($navigator=='ordersHold')? '' : '_o';?>.png" width="24" height="24" /></span><br><span>在手订单</span></a>
        <a class="<?php echo ($navigator=='ordersHistory')? 'active' : '';?>" href="/orders/history"><span><img src="/Public/imgs/bar03<?php echo ($navigator=='ordersHistory')? '' : '_o';?>.png" width="24" height="24" /></span><br><span>历史订单</span></a>
		<a class="<?php echo ($navigator=='account')? 'active' : '';?>" href="/account"><span><img src="/Public/imgs/bar04<?php echo ($navigator=='account')? '' : '_o';?>.png" width="24" height="24" /></span><br><span>会员中心</span></a>
