    ...
    <div class="row">
        <div class="col-lg-8 col-sm-8 col-xs-12" style="margin-top: 15px;">
            ...
            <ul class="nav nav-tabs" style="margin-bottom: 20px;">
              ...
              <?php if(is_array($cationlist)): $i = 0; $__LIST__ = $cationlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i % 2 );++$i;?><li role="presentation" class="navli" data-id="<?php echo ($vo3["id"]); ?>"><a onclick="ajax_get_table(<?php echo ($vo3["id"]); ?>,1)"><?php echo ($vo3["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <div id="ajax_return">
        ...
        <div class="col-lg-4 col-sm-4 col-xs-12">
            ...
            <script> 
                ...
                function ajax_get_table(tab,page){
                    ...
                    var url = "<?php echo U('Goods/ajaxindex');?>";
                    $.ajax({
                        type : "POST",
                        url:url+"?p="+page,//+tab,
