        ...
        <div class="col-lg-4 col-sm-4 col-xs-12">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item"><i class="glyphicon glyphicon-earphone">&nbsp;</i> 
                <a href="tel:<?php echo ($enprArr["phone"]); ?>" style="color: #333"><?php echo ($enprArr["phone"]); ?></a>
              </li>
              ...
              <!-- 轮播组件 -->
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner" role="listbox">
                    <?php if(is_array($goodArr['original_img'])): $k = 0; $__LIST__ = $goodArr['original_img'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="item">
                          <a href="#"><img src="<?php echo ($vo); ?>" alt="..." title="<?php echo ($goodArr["goods_name"]); ?>"></a>
                ...
                <div class="alert alert-warning" role="alert" style="margin-top: 10px;">
                    <h4><?php echo ($goodArr["goods_name"]); ?></h4>
                    <p>
                      <?php if($vo2["market_price"] != 0.00 ): ?><s><?php echo ($vo2["market_price"]); ?></s>&nbsp;<?php endif; ?>
                      <strong style="color: red;"><?php echo ($goodArr["shop_price"]); ?></strong>
                    </p>
                    <p><?php echo ($goodArr["goods_remark"]); ?></p>
                </div>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <?php echo ($goodArr["goods_content"]); ?>
                  </div>
                </div>
        </div>
